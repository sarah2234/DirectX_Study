...
{
	bool result;
	WCHAR textureVsFile[50] = L"../DirectX2D/HLSL/texture.vs";
	WCHAR texturePsFile[50] = L"../DirectX2D/HLSL/texture.ps";

	// Initialize the vertex and pixel shaders
	result = InitializeShader(device, hwnd, textureVsFile, texturePsFile);
	if (!result)
		return false;
...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	// 'TextureVertexShader' is defined in texture.vs
